    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            {...register("serviceCategory", { required: "Catégorie de service requise" })}
            className="form-input"
            placeholder="Ex: Installation, Fuite , etc."
          />
          {errors.serviceCategory && <p className="error-message">{errors.serviceCategory.message}</p>}
        </div>
        ...
        {serviceCategory && (
          <div className="highlighted-group">
            ...
            <textarea 
              ...
              placeholder="Décrivez en détail le service nécessaire"
              rows={3}
            />
